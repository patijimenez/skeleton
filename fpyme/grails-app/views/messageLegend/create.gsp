...
<html>
	...
	<body>
		<a href="#create-messageLegend" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div id="create-messageLegend" class="containercontent scaffold-create" role="main">
      <div class="row">
        <div class="span12">
          <div class="navbar">
